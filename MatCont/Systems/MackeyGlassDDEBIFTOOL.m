function out = MackeyGlassDDEBIFTOOL
out{1} = @init;
out{2} = @fun_eval;
out{3} = [];
out{4} = [];
...
function dydt = fun_eval (t,state,par_beta,par_TAU,par_gamma,par_n)
M=10;
...
GM = @(x)par_beta*(commonFunctions.interpoly(-par_TAU,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights)/(1+commonFunctions.interpoly(-par_TAU,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights)^par_n))-par_gamma*yM(1);
KM=[]; 
...
% --------------------------------------------------------------------------
function jac = jacobian(t,kmrgd,par_beta,par_TAU,par_gamma,par_n)
% --------------------------------------------------------------------------
function jacp = jacobianp(t,kmrgd,par_beta,par_TAU,par_gamma,par_n)
% --------------------------------------------------------------------------
function hess = hessians(t,kmrgd,par_beta,par_TAU,par_gamma,par_n)
% --------------------------------------------------------------------------
function hessp = hessiansp(t,kmrgd,par_beta,par_TAU,par_gamma,par_n)
%---------------------------------------------------------------------------
function tens3  = der3(t,kmrgd,par_beta,par_TAU,par_gamma,par_n)
%---------------------------------------------------------------------------
function tens4  = der4(t,kmrgd,par_beta,par_TAU,par_gamma,par_n)
%---------------------------------------------------------------------------
function tens5  = der5(t,kmrgd,par_beta,par_TAU,par_gamma,par_n)
