...
GM = @(x)par_r*yM(1)*(1-dot([commonFunctions.interpoly(-0*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.024472*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.095492*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.20611*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.34549*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.5*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.65451*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.79389*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.90451*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--0.97553*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),
commonFunctions.interpoly(--1*(t-(0))+t,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights)],UnitQuadweights)*(t-(0)));
KM=[]; 
