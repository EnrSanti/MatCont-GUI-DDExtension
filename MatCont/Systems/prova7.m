...
temporanea=2*dot(commonFunctions.interpoly(+thetaCap*(-2-(-3))+-3,tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights),wCap)*(-2-(-3));
GM = [temporanea+2                               ;
par_a*3+commonFunctions.interpoly(-3,tau_max*UnitNodes,[yM(2);VM(2:d2:end)],BaryWeights)];
