...
function dydt = fun_eval (t,state,par_beta,par_a,par_abar)
M=20;
...
KM = derState - kron([par_beta.*dot(commonFunctions.interpoly(-thetaCap*(par_abar-(par_a))+par_a,tau_max*UnitNodes,[0;UM(1:d1:end)],BaryWeights).*exp(commonFunctions.interpoly(-thetaCap*(par_abar-(par_a))+par_a,tau_max*UnitNodes,[0;UM(1:d1:end)],BaryWeights)),wCap)*(par_abar-(par_a))],ones(M,1));
dydt= [KM];
...
% --------------------------------------------------------------------------
function jac = jacobian(t,kmrgd,par_beta,par_a,par_abar)
% --------------------------------------------------------------------------
function jacp = jacobianp(t,kmrgd,par_beta,par_a,par_abar)
% --------------------------------------------------------------------------
function hess = hessians(t,kmrgd,par_beta,par_a,par_abar)
% --------------------------------------------------------------------------
function hessp = hessiansp(t,kmrgd,par_beta,par_a,par_abar)
%---------------------------------------------------------------------------
function tens3  = der3(t,kmrgd,par_beta,par_a,par_abar)
%---------------------------------------------------------------------------
function tens4  = der4(t,kmrgd,par_beta,par_a,par_abar)
%---------------------------------------------------------------------------
function tens5  = der5(t,kmrgd,par_beta,par_a,par_abar)
