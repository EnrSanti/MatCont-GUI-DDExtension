...
par_conv*par_pred*exp(-par_juv_death*par_TAU)*commonFunctions.interpoly(-par_TAU,tau_max*UnitNodes,[yM(1);VM(1:2:end)],BaryWeights)*commonFunctions.interpoly(-par_TAU,tau_max*UnitNodes,[yM(2);VM(2:2:end)],BaryWeights)-par_death*yM(2)];
KM=[]; 
