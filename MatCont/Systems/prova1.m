...
KM = derState - kron([dot(commonFunctions.interpoly(-thetaCap*(2.*par_a-(par_a))+par_a,tau_max*UnitNodes,[0;UM(1:d1:end)],BaryWeights).*33,wCap)*(2.*par_a-(par_a))+2],ones(M,1));
