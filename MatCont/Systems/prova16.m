...
KM = derState - kron([dot(11+commonFunctions.interpoly(+thetaCap*(-4-(TMP1))+TMP1,tau_max*UnitNodes,[0;UM(1:d1:end)],BaryWeights),wCap)*(-4-(TMP1)).^2],ones(M,1));
