...
function dydt = fun_eval (t,state,par_a,par_b,par_TAU1,par_TAU2)
M=10;
...
d1=0;
d2=2;
delayFunctions=[-cor_x[t-1],-TAU,-cor_y[t-par_TAU2+1]];
...
GM = @(x) [par_a*yM(1)*(1-commonFunctions.interpoly(-yM(1)[t-1],tau_max*UnitNodes,[yM(1);VM(1:d2:end)],BaryWeights))            ;
par_b*commonFunctions.interpoly(-TAU,tau_max*UnitNodes,[yM(2);VM(2:d2:end)],BaryWeights)+commonFunctions.interpoly(-TAU,tau_max*UnitNodes,[yM(2);VM(2:d2:end)],BaryWeights)];
KM=[]; 
...
% --------------------------------------------------------------------------
function jac = jacobian(t,kmrgd,par_a,par_b,par_TAU1,par_TAU2)
% --------------------------------------------------------------------------
function jacp = jacobianp(t,kmrgd,par_a,par_b,par_TAU1,par_TAU2)
% --------------------------------------------------------------------------
function hess = hessians(t,kmrgd,par_a,par_b,par_TAU1,par_TAU2)
% --------------------------------------------------------------------------
function hessp = hessiansp(t,kmrgd,par_a,par_b,par_TAU1,par_TAU2)
%---------------------------------------------------------------------------
function tens3  = der3(t,kmrgd,par_a,par_b,par_TAU1,par_TAU2)
%---------------------------------------------------------------------------
function tens4  = der4(t,kmrgd,par_a,par_b,par_TAU1,par_TAU2)
%---------------------------------------------------------------------------
function tens5  = der5(t,kmrgd,par_a,par_b,par_TAU1,par_TAU2)
